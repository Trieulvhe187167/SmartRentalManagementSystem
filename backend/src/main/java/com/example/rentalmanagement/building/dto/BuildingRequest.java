package com.example.rentalmanagement.building.dto;
...
public record BuildingRequest(@NotBlank String code, @NotBlank @Size(max = 150) String name, @NotBlank @Size(max = 500) String address, String description) {
}
