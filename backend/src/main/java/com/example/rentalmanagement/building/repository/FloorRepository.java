package com.example.rentalmanagement.building.repository;
...
public interface FloorRepository extends JpaRepository<Floor, Long> {
    public Page<Floor> findByBuildingId(Long buildingId, Pageable pageable);
    public boolean existsByBuildingIdAndFloorNumber(Long buildingId, Integer floorNumber);
}
