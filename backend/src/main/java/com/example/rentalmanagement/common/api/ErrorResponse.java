...
public record ErrorResponse(
    ...
    public static ErrorResponse of(String message, String errorCode, List<String> details, String path) {
        return new ErrorResponse(false, message, errorCode, details, LocalDateTime.now(), path);
    }
}
