...
@Entity
@Table(name = "contract_occupants", uniqueConstraints = @UniqueConstraint(columnNames = {"contract_id", "occupant_id"}))
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
public class ContractOccupant extends AuditableEntity {
