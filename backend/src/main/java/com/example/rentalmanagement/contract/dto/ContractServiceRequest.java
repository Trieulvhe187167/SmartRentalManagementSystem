...
public record ContractServiceRequest(@NotNull Long contractId, @NotNull Long serviceId, @NotNull LocalDate startDate, LocalDate endDate, Boolean active, String notes) {
}
