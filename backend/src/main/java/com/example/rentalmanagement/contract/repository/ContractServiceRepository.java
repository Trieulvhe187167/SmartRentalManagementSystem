...
public interface ContractServiceRepository extends JpaRepository<ContractService, Long> {
    public List<ContractService> findByContractIdAndStatusAndIsDeletedFalse(Long contractId, RecordStatus status);
    public Page<ContractService> findByContractIdAndIsDeletedFalse(Long contractId, Pageable pageable);
}
