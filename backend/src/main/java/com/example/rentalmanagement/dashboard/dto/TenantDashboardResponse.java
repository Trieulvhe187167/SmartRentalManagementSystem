...
public record TenantDashboardResponse(RentalContract currentContract, Room currentRoom, Invoice latestInvoice, BigDecimal currentDebt, long unreadNotifications) {
}
