package com.example.rentalmanagement.invoice.dto;
...
public record InvoiceAdjustmentRequest(@NotBlank String description, @NotNull BigDecimal amount, String unit, @NotNull @DecimalMin("0.000") BigDecimal quantity, String note) {
}
