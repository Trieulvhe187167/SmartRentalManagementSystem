package com.example.rentalmanagement.maintenance.dto;
...
public record MaintenanceRequestCreateRequest(Long contractId, Long roomId, @NotBlank @Size(max = 200) String title, @NotBlank String description, @NotNull MaintenancePriority priority) {
}
