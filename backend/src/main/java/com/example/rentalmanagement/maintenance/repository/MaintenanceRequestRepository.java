package com.example.rentalmanagement.maintenance.repository;
...
public interface MaintenanceRequestRepository extends JpaRepository<MaintenanceRequestEntity, Long> {
    public Page<MaintenanceRequestEntity> findByRequesterUserIdAndIsDeletedFalse(Long userId, Pageable pageable);
