package com.example.rentalmanagement.meterreading.dto;
...
public record MeterReadingRequest(
        ...
        @NotNull @DecimalMin("0.000") BigDecimal previousReading,
        @NotNull @DecimalMin("0.000") BigDecimal currentReading,
