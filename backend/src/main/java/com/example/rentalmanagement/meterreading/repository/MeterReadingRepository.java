package com.example.rentalmanagement.meterreading.repository;
...
public interface MeterReadingRepository extends JpaRepository<MeterReading, Long> {
    public boolean existsByRoomIdAndServiceItemIdAndBillingMonthAndBillingYearAndIsDeletedFalse(Long roomId, Long serviceId, Integer billingMonth, Integer billingYear);
    public Optional<MeterReading> findByRoomIdAndServiceItemIdAndBillingMonthAndBillingYearAndIsDeletedFalse(Long roomId, Long serviceId, Integer billingMonth, Integer billingYear);
    public Optional<MeterReading> findFirstByRoomIdAndIsDeletedFalseOrderByBillingYearDescBillingMonthDescReadingDateDesc(Long roomId);
    public Optional<MeterReading> findFirstByRoomIdAndServiceItemIdAndIsDeletedFalseOrderByBillingYearDescBillingMonthDescReadingDateDesc(Long roomId, Long serviceId);
    public Page<MeterReading> findByRoomIdAndIsDeletedFalse(Long roomId, Pageable pageable);
}
