package com.example.rentalmanagement.notification.dto;
...
public record NotificationGeneralRequest(@NotNull Long userId, @NotBlank String title, @NotBlank String content) {
}
