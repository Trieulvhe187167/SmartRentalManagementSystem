package com.example.rentalmanagement.payment.repository;
...
public interface PaymentRepository extends JpaRepository<Payment, Long> {
    ...
    @Query("""
            ...
            """)
    public Page<Payment> search(@Param("invoiceId") Long invoiceId, @Param("status") PaymentStatus status, Pageable pageable);
}
