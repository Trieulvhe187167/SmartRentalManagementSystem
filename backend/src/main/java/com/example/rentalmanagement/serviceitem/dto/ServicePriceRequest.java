package com.example.rentalmanagement.serviceitem.dto;
...
public record ServicePriceRequest(Long serviceId, @NotNull @DecimalMin("0.00") BigDecimal unitPrice, @NotNull LocalDate effectiveFrom, LocalDate effectiveTo, String notes) {
}
